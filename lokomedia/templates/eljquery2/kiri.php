   ...
   while($r=mysql_fetch_array($main)){
     echo "<br /><li><div id=kotakjudul>
          ...
          $t=mysql_fetch_array($sub2);
                ...
                $isi = substr($isi_berita,0,strrpos($isi," ")); // potong per spasi kalimat
                echo "<li class='garisbawah'><span class=judulnya><a href='berita-$t[id_berita]-$t[judul_seo].html'>$t[judul]</a></span><br />
                      <span class=tanggal>$t[hari], $tgl - $t[jam] WIB</span><br /><br /> 
                      $isi ... <a href=berita-$t[id_berita]-$t[judul_seo].html>Selengkapnya</a> 
                      </li>";
                      	        
          while($w=mysql_fetch_array($sub)){
              echo "<li class='garisbawah'><a href='berita-$w[id_berita]-$w[judul_seo].html'>&#187; $w[judul]</a></li>";
	         }
	       echo "</ul>
                </tbody>
                </table>
...
echo "</ul>";        
	            ...
	            // Galeri Foto (tampilkan 12 foto secara horizontal)
              echo "<br /><br /><img src='$f[folder]/images/galeri.jpg' /><br />";

              // Tentukan kolom
              $col = 6;
              $g = mysql_query("SELECT * FROM gallery ORDER BY id_gallery DESC LIMIT 12");
